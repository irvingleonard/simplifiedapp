...
class TestExecuteCallable(TestCase):
	...
	def test_not_callable(self):
		"""
		Testing "Callable.__call__" with a non-callable value
		"""
	...
	def test_function_w_all_parameter_combinations(self):
		"""
		Testing "Callable.__call__" with a function that takes every possible parameter
		"""
		...
		expected_result = "aNonea_strFalse['as', 1, True]{1: 'one', 'dct': 6, 'fer': False}2.3('ep1', 'ep2')hereNoneanother_strTrue[1, 'tre', 6.7]{1: 'dfe', 'yufgb': 'sdqwda'}(8+98j){}"
	...
	def test_class_w_new_and_init(self):
		"""
		Testing "Callable.__call__" with a class that implements __new__ and __init__
		"""
