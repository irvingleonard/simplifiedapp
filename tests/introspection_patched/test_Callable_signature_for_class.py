...
class TestCallableSignatureForClass(TestCase):
	...
	def test_class_w_new_n_init_complex(self):
		...
		self.assertEqual(expected_result, Callable._signature_for_class(FixtureClassWNewAndInitComplex))
	...
	def test_class_w_new_n_init_matching(self):
		...
		self.assertEqual(expected_result, Callable._signature_for_class(FixtureClassWNewAndInitMatching))
	...
	def test_class_w_new_n_init_mismatch_positional(self):
		...
		with self.assertWarns(SyntaxWarning):
			result = Callable._signature_for_class(FixtureClassWNewAndInitMismatchPositional)
	...
	def test_class_w_new_n_init_mismatch_positional_or_keyword(self):
		...
		with self.assertWarns(SyntaxWarning):
			result = Callable._signature_for_class(FixtureClassWNewAndInitMismatchPositionalOrKeyword)
		self.assertEqual(expected_result, result)
	...
	def test_class_w_new_n_init_n_flexible_new(self):
		...
		self.assertEqual(expected_result, Callable._signature_for_class(FixtureClassWNewAndInitFNew))
	...
	def test_class_w_new_n_init_n_flexible_init(self):
		...
		self.assertEqual(expected_result, Callable._signature_for_class(FixtureClassWNewAndInitFInit))
