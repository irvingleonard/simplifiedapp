...
from simplifiedapp._introspection import object_metadata, parameters_from_method
...
class TestParametersFromMethod(TestCase):
	...
	def _test_simple_callable(self):
		'''
	...
	def _test_instance_method(self):
		'''
